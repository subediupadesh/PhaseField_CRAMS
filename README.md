...
The pseudo-binary formulation for multicomponent steel is accomplished using pyMPEALab toolkit [1]. It is to be noted that differed processing parameters (P, vscan) can alter the growth kinetics and stability of gamma and alpha phases.
